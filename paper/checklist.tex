...
\item {\bf Claims}
    ...
    \item[] Justification: The abstract claims that CausalComp reduces prediction error on unseen combinations by 20\% compared to non-causal baselines and achieves the lowest compositional gap among graph-based methods. These claims are supported by Tables~1--3 across three environments.
