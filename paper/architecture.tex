...
\begin{scope}[on background layer]
    \fill[gray!6, rounded corners=8pt] (-1.8,-3.5) rectangle (17.2,3.6);
    \draw[gray!30, rounded corners=8pt, line width=0.8pt] (-1.8,-3.5) rectangle (17.2,3.6);
\end{scope}
...
\coordinate (ar_br) at ($(dec.south)+(0,-2.4)$);
\coordinate (ar_bl) at ($(enc.south)+(0,-2.4)$);
